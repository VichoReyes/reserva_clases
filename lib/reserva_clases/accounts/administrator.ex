defmodule ReservaClases.Accounts.Administrator do
  use Ecto.Schema
  ...
  @doc """
  A administrator changeset for registration.
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, ReservaClases.Repo)
  ...
  """
  def email_changeset(administrator, attrs, opts \\ []) do
    administrator
    |> cast(attrs, [:email])
    |> validate_email(opts)
    |> case do
  ...
  """
  def valid_password?(%ReservaClases.Accounts.Administrator{hashed_password: hashed_password}, password)
