defmodule ReservaClasesWeb.CoreComponents do
  @moduledoc """
  ...
  def flash_group(assigns) do
    ~H"""
    <.flash kind={:info} title="Bien" flash={@flash} />
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ReservaClasesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ReservaClasesWeb.Gettext, "errors", msg, opts)
    end
  end
